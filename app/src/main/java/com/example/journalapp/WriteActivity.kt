...
class WriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(from=="null"){
            ...
            val content_txt:CharSequence = intent.getStringExtra("content").toString()
        ...
        binding.back.setOnClickListener {
            ...
            if(saved || count == 2){
                ...
                Toast.makeText(this, "Changes are not saved!! Press again to discard changes !!",Toast.LENGTH_SHORT).show()
            }
        }
    }
}